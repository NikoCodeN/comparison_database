...
$sql= "SELECT interna.Numero_Documento,interna.Nombre ,externa.Apellidos, externa.Id_Usuario FROM interna INNER JOIN externa ON interna.Numero_Documento=externa.Numero_Documento  and interna.Nombre=externa.Nombre WHERE Id_Usuario=${Id_Usuario}" ;
?>
<table border="1">
 <thead>
    <tr>
